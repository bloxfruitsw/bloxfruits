...
local suskey = request({Url = "https://gist.githubusercontent.com/MRSBLACK999/bdc60c665fcfadd2e0a4fae9109baf83/raw/6f270085a0bf3fe57fdb9db8c3f18e555794480a/Key%2520check",Method = "GET"}).Body

VerifyButton.Name = "Unlock Script"
...
VerifyButton.MouseButton1Down:connect(function()
	if KeyBox.Text == suskey then
		...
		game.StarterGui:SetCore("SendNotification", {Title = "Correct Key!!", Text = "Loading Wait 7 sec", Icon = "rbxassetid://12206884774", Duration = 4})

		wait(7)

		GUI.Parent = nil

loadstring(game:HttpGet("https://pastebin.com/raw/7s1ggcgj"))()
...
GetKey.BackgroundColor3 = Color3.fromRGB(2, 2, 6)
...
GetKey.MouseButton1Down:connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/bloxfruitsw/bloxfruits/refs/heads/main/motjint'))()
	game.StarterGui:SetCore("SendNotification", {Title = "Key Info", Text = "Key Link Copied", Icon = "", Duration = 5})
end)
